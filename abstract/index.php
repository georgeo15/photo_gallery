...
<form>
  ...
  <select id ="select" >
  <option value="selected" selected disabled>SELECT BY ART</option>
  <option value="disbaled" disabled></option>
  <option value="http://users.metropolia.fi/~georgeo/gallery">Classic Art</option>
  <option value="http://users.metropolia.fi/~georgeo/gallery/abstract">Abstract Art</option>
